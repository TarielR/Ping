...
public class PersonServiceImpl implements PersonService {
    ...
    private void createPersons() {
        ...
        Person child04 = new Person(4L,"Kate", LocalDate.of(2005, 2, 13), null, null, address01);
        ...
        //person01.setSpouse(person02);
        Person person03 = new Person(9L, "Rosi Potter", LocalDate.of(1971, 7, 10), 10L, children02, address02);
        Person person04 = new Person(10L, "Peter Potter", LocalDate.of(1976, 9, 6), 9L, children01, address02);
        //person03.setSpouse(person04);
